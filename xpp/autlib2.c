...
struct {
    doublereal u0xx[152], u1xx[152], u2xx[152], f1xx[152], f2xx[152], dfuxx[
	    6000]	/* was [50][120] */, dfpxx[1000]	/* was [50][
	    20] */, dduxx[50], ddpxx[20];
} blwif_;

#define blwif_1 blwif_

struct {
    doublereal u1zz[50], u2zz[50], f1zz[50], f2zz[50];
} bldif_;
...
doublereal *dfdu, *dfdp, *dtm;
{
    ...
    /* Local variables */
    static integer i, j;
    extern /* Subroutine */ int scaleb_(), extrbv_(), stupbv_();
...
/*        Rescale, to set the norm of (UDOTPS,RLDOT) equal to 1. */
    scaleb_(m1u, &udotps[udotps_offset], blcrl_1.rldot, &dtm[1]);
...
S) : \002,/,10e11.3,/,10e11.3)";
    ...
    static integer i, j;
    extern /* Subroutine */ int scaleb_(), setubv_();
...
integer *m1df;
{
    ...
    /* Local variables */
    static integer itmp;
    static doublereal ulow[100];
    extern doublereal rnrm2_();
    static integer ntot1, i,iflag,i_1;
    static doublereal uhigh[100],u0[100],ubar[100];
