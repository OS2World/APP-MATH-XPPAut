...
init_auto(ndim,ips,irs,ilp,ntst,isp,isw,nmx,npr,
	  ds,dsmin,dsmax,rl0,rl1,a0,a1,
	  ip1,ip2,nuzr)
     int ndim,ips,irs,ilp,ntst,isp,isw,nmx,npr,ip1,ip2;
     int nuzr;
     double ds,dsmin,dsmax,rl0,rl1,a0,a1;
{
